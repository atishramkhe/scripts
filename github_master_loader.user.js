                ...
                if (response.status === 200) {
                    ...
                    if (shouldExecuteScript(currentUrl, scriptContent)) {
                        try {
                            ...
                            eval(scriptContent);
                            console.log(`[Master Script] Successfully loaded and executed: ${url}`);
                        } catch (e) {
                            console.error(`[Master Script] Error executing script from ${url}:`, e);
                        }
                    } else {
                        console.log(`[Master Script] Skipping script ${url} as it does not match the current URL: ${currentUrl}`);
                    }
                } else {
